// Sebagai QA Engineer kalian ingin mengecek total quantity  dari bebarapa storageId 
// untuk productCode FBR00040101 (FloBrand-DressBSPink). 
...
let productBin = {
  ...
  for (let i = 0; i < productBin.data.length; i++) {
    let quantity = productBin.data[i].quantity;
